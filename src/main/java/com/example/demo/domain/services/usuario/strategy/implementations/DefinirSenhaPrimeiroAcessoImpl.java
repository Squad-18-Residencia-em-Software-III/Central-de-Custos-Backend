...
@Component
@Slf4j
public class DefinirSenhaPrimeiroAcessoImpl implements DefinirSenhaUsuarioStrategy {

    private final BCryptPasswordEncoder bCryptPasswordEncoder;

    public DefinirSenhaPrimeiroAcessoImpl(BCryptPasswordEncoder bCryptPasswordEncoder) {
