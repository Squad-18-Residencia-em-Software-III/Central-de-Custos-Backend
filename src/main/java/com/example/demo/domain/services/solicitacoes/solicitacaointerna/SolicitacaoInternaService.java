...
public class SolicitacaoInternaService {
    ...
    public SolicitacaoInternaService(SolicitacaoFactory solicitacaoFactory, SolicitacaoValidator solicitacaoValidator, SolicitacaoInternaRepository solicitacaoInternaRepository) {
    ...
    @Transactional
    public void definirStatusSolicitacao(UUID solicitacaoInternaId, StatusSolicitacao statusSolicitacao, RespostaSolicitacaoInterna resposta){
