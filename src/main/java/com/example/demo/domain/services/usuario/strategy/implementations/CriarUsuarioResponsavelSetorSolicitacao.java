...
public class CriarUsuarioResponsavelSetorSolicitacao implements CriarUsuarioSolicitacaoStrategy {
    ...
    public CriarUsuarioResponsavelSetorSolicitacao(UsuarioValidator usuarioValidator, UsuarioRepository usuarioRepository, TokensService tokensService, BCryptPasswordEncoder bCryptPasswordEncoder, UsuarioMapper usuarioMapper) {
