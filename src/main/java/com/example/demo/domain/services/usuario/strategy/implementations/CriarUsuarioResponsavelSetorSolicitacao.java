...
@Component
public class CriarUsuarioResponsavelSetorSolicitacao implements CriarUsuarioSolicitacaoStrategy {
    ...
    public CriarUsuarioResponsavelSetorSolicitacao(UsuarioValidator usuarioValidator, UsuarioRepository usuarioRepository, TokensService tokensService, BCryptPasswordEncoder bCryptPasswordEncoder, UsuarioMapper usuarioMapper, EmailFactory emailFactory) {
    ...
    public void criarUsuario(SolicitacaoCadastroUsuario solicitacao) {
        ...
        Perfil perfil = usuarioValidator.validaPerfilExisteNome("RESPONSAVEL_SETOR");
