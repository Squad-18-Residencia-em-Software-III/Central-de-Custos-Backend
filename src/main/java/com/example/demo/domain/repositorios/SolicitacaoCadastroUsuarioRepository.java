...
public interface SolicitacaoCadastroUsuarioRepository extends JpaRepository<SolicitacaoCadastroUsuario, Long>, JpaSpecificationExecutor<SolicitacaoCadastroUsuario> {
